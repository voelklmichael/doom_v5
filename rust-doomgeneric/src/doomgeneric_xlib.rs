...
pub const KeyPressMask: i64 = (1 as i64) << 0 as i32;
pub const KeyReleaseMask: i64 = (1 as i64) << 1 as i32;
pub const ExposureMask: i64 = (1 as i64) << 15 as i32;
pub const StructureNotifyMask: i64 = (1 as i64) << 17 as i32;
        ...
        _ => {
            key = ({
                ...
                if ::core::mem::size_of::<u32>() as usize > 1 as usize {
                    ...
                    __res = *(*__ctype_tolower_loc()).offset(key as i32 as isize) as i32;
                }
                __res
            }) as u32;
        }
...
unsafe extern "C" fn addKeyToQueue(mut pressed: i32, mut keyCode: u32) {
    ...
    let mut keyData: u16 = (pressed << 8 as i32 | key as i32) as u16;
...
pub unsafe extern "C" fn DG_Init() {
    ...
    XkbSetDetectableAutoRepeat(s_Display, 1 as i32, ::core::ptr::null_mut::<i32>());
    loop {
    ...
    if !s_Display.is_null() {
        while XPending(s_Display) > 0 as i32 {
            ...
            if e.type_0 == KeyPress {
                let mut sym: KeySym =
                    XkbKeycodeToKeysym(s_Display, e.xkey.keycode as KeyCode, 0 as i32, 0 as i32);
...
pub unsafe extern "C" fn DG_GetTicksMs() -> uint32_t {
    ...
    return (tp.tv_sec as __suseconds_t * 1000 as __suseconds_t + tp.tv_usec / 1000 as __suseconds_t)
        as uint32_t;
}
#[no_mangle]
pub unsafe extern "C" fn DG_GetKey(mut pressed: *mut i32, mut doomKey: *mut u8) -> i32 {
    if s_KeyQueueReadIndex == s_KeyQueueWriteIndex {
        ...
        *doomKey = (keyData as i32 & 0xff as i32) as u8;
        return 1 as i32;
    };
}
#[no_mangle]
