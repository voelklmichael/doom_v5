...
pub unsafe extern "C" fn P_GiveAmmo(
    ...
    match ammo as ::core::ffi::c_uint {
        0 => {
            ...
            {
                if (*player).weaponowned[wp_chaingun as ::core::ffi::c_int as usize]
                {
        ...
        1 => {
            ...
            {
                if (*player).weaponowned[wp_shotgun as ::core::ffi::c_int as usize]
                {
        ...
        2 => {
            if (*player).readyweapon as ::core::ffi::c_uint
                ...
                || (*player).readyweapon as ::core::ffi::c_uint
                    == wp_pistol as ::core::ffi::c_int as ::core::ffi::c_uint
            {
                if (*player).weaponowned[wp_plasma as ::core::ffi::c_int as usize] {
        ...
        3 => {
            if (*player).readyweapon as ::core::ffi::c_uint
                == wp_fist as ::core::ffi::c_int as ::core::ffi::c_uint
            {
                if (*player).weaponowned[wp_missile as ::core::ffi::c_int as usize]
                {
...
pub unsafe extern "C" fn P_TouchSpecialThing(
    ...
    match (*special).sprite as ::core::ffi::c_uint {
        ...
        65 => {
            if !(*player).cards[it_blueskull as ::core::ffi::c_int as usize] {
        ...
        67 => {
            if !(*player).cards[it_yellowskull as ::core::ffi::c_int as usize] {
        ...
        66 => {
            if !(*player).cards[it_redskull as ::core::ffi::c_int as usize] {
