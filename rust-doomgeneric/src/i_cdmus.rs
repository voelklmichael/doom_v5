...
pub unsafe fn I_CDMusPlay(mut track: i32) -> i32 {
    return 0 as i32;
}
...
pub fn I_CDMusSetVolume(state: &mut ICdMusState, mut volume: i32) -> i32 {
...
pub unsafe fn I_CDMusTrackLength(mut track_num: i32) -> i32 {
    return 0 as i32;
}
