...
pub const sfx_skesit: C2RustUnnamed_3 = 106;
pub const sfx_skeact: C2RustUnnamed_3 = 105;
pub const sfx_keendt: C2RustUnnamed_3 = 104;
pub const sfx_keenpn: C2RustUnnamed_3 = 103;
pub const sfx_ssdth: C2RustUnnamed_3 = 102;
pub const sfx_sssit: C2RustUnnamed_3 = 101;
pub const sfx_mandth: C2RustUnnamed_3 = 100;
pub const sfx_manatk: C2RustUnnamed_3 = 99;
pub const sfx_bosdth: C2RustUnnamed_3 = 98;
pub const sfx_bospn: C2RustUnnamed_3 = 97;
pub const sfx_bossit: C2RustUnnamed_3 = 96;
pub const sfx_boscub: C2RustUnnamed_3 = 95;
pub const sfx_bospit: C2RustUnnamed_3 = 94;
pub const sfx_getpow: C2RustUnnamed_3 = 93;
pub const sfx_flamst: C2RustUnnamed_3 = 92;
pub const sfx_flame: C2RustUnnamed_3 = 91;
pub const sfx_itmbk: C2RustUnnamed_3 = 90;
pub const sfx_bdcls: C2RustUnnamed_3 = 89;
pub const sfx_bdopn: C2RustUnnamed_3 = 88;
pub const sfx_tink: C2RustUnnamed_3 = 87;
pub const sfx_chgun: C2RustUnnamed_3 = 86;
pub const sfx_metal: C2RustUnnamed_3 = 85;
pub const sfx_hoof: C2RustUnnamed_3 = 84;
pub const sfx_punch: C2RustUnnamed_3 = 83;
pub const sfx_barexp: C2RustUnnamed_3 = 82;
pub const sfx_noway: C2RustUnnamed_3 = 81;
pub const sfx_vilact: C2RustUnnamed_3 = 80;
pub const sfx_bspwlk: C2RustUnnamed_3 = 79;
pub const sfx_bspact: C2RustUnnamed_3 = 78;
pub const sfx_dmact: C2RustUnnamed_3 = 77;
pub const sfx_bgact: C2RustUnnamed_3 = 76;
pub const sfx_posact: C2RustUnnamed_3 = 75;
pub const sfx_skedth: C2RustUnnamed_3 = 74;
pub const sfx_pedth: C2RustUnnamed_3 = 73;
pub const sfx_kntdth: C2RustUnnamed_3 = 72;
pub const sfx_vildth: C2RustUnnamed_3 = 71;
pub const sfx_bspdth: C2RustUnnamed_3 = 70;
pub const sfx_spidth: C2RustUnnamed_3 = 69;
pub const sfx_cybdth: C2RustUnnamed_3 = 68;
pub const sfx_brsdth: C2RustUnnamed_3 = 67;
pub const sfx_skldth: C2RustUnnamed_3 = 66;
pub const sfx_cacdth: C2RustUnnamed_3 = 65;
pub const sfx_sgtdth: C2RustUnnamed_3 = 64;
pub const sfx_bgdth2: C2RustUnnamed_3 = 63;
pub const sfx_bgdth1: C2RustUnnamed_3 = 62;
pub const sfx_podth3: C2RustUnnamed_3 = 61;
pub const sfx_podth2: C2RustUnnamed_3 = 60;
pub const sfx_podth1: C2RustUnnamed_3 = 59;
pub const sfx_pdiehi: C2RustUnnamed_3 = 58;
pub const sfx_pldeth: C2RustUnnamed_3 = 57;
pub const sfx_skeswg: C2RustUnnamed_3 = 56;
pub const sfx_claw: C2RustUnnamed_3 = 55;
pub const sfx_vilatk: C2RustUnnamed_3 = 54;
pub const sfx_skepch: C2RustUnnamed_3 = 53;
pub const sfx_sgtatk: C2RustUnnamed_3 = 52;
pub const sfx_sklatk: C2RustUnnamed_3 = 51;
pub const sfx_pesit: C2RustUnnamed_3 = 50;
pub const sfx_mansit: C2RustUnnamed_3 = 49;
pub const sfx_vilsit: C2RustUnnamed_3 = 48;
pub const sfx_kntsit: C2RustUnnamed_3 = 47;
pub const sfx_bspsit: C2RustUnnamed_3 = 46;
pub const sfx_spisit: C2RustUnnamed_3 = 45;
pub const sfx_cybsit: C2RustUnnamed_3 = 44;
pub const sfx_brssit: C2RustUnnamed_3 = 43;
pub const sfx_cacsit: C2RustUnnamed_3 = 42;
pub const sfx_sgtsit: C2RustUnnamed_3 = 41;
pub const sfx_bgsit2: C2RustUnnamed_3 = 40;
pub const sfx_bgsit1: C2RustUnnamed_3 = 39;
pub const sfx_posit3: C2RustUnnamed_3 = 38;
pub const sfx_posit2: C2RustUnnamed_3 = 37;
pub const sfx_posit1: C2RustUnnamed_3 = 36;
pub const sfx_telept: C2RustUnnamed_3 = 35;
pub const sfx_oof: C2RustUnnamed_3 = 34;
pub const sfx_wpnup: C2RustUnnamed_3 = 33;
pub const sfx_itemup: C2RustUnnamed_3 = 32;
pub const sfx_slop: C2RustUnnamed_3 = 31;
pub const sfx_pepain: C2RustUnnamed_3 = 30;
pub const sfx_mnpain: C2RustUnnamed_3 = 29;
pub const sfx_vipain: C2RustUnnamed_3 = 28;
pub const sfx_popain: C2RustUnnamed_3 = 27;
pub const sfx_dmpain: C2RustUnnamed_3 = 26;
pub const sfx_plpain: C2RustUnnamed_3 = 25;
pub const sfx_swtchx: C2RustUnnamed_3 = 24;
pub const sfx_swtchn: C2RustUnnamed_3 = 23;
pub const sfx_stnmov: C2RustUnnamed_3 = 22;
pub const sfx_dorcls: C2RustUnnamed_3 = 21;
pub const sfx_doropn: C2RustUnnamed_3 = 20;
pub const sfx_pstop: C2RustUnnamed_3 = 19;
pub const sfx_pstart: C2RustUnnamed_3 = 18;
pub const sfx_firxpl: C2RustUnnamed_3 = 17;
pub const sfx_firsht: C2RustUnnamed_3 = 16;
pub const sfx_rxplod: C2RustUnnamed_3 = 15;
pub const sfx_rlaunc: C2RustUnnamed_3 = 14;
pub const sfx_sawhit: C2RustUnnamed_3 = 13;
pub const sfx_sawful: C2RustUnnamed_3 = 12;
pub const sfx_sawidl: C2RustUnnamed_3 = 11;
pub const sfx_bfg: C2RustUnnamed_3 = 9;
pub const sfx_plasma: C2RustUnnamed_3 = 8;
pub const sfx_dbload: C2RustUnnamed_3 = 7;
pub const sfx_dbcls: C2RustUnnamed_3 = 6;
pub const sfx_dbopn: C2RustUnnamed_3 = 5;
pub const sfx_dshtgn: C2RustUnnamed_3 = 4;
pub const sfx_sgcock: C2RustUnnamed_3 = 3;
...
pub unsafe extern "C" fn P_CheckAmmo(mut player: *mut player_t) -> boolean {
    ...
    loop {
        ...
        } else if (*player).weaponowned[wp_chaingun as ::core::ffi::c_int as usize]
            && (*player).ammo[am_clip as ::core::ffi::c_int as usize] != 0
        {
            (*player).pendingweapon = wp_chaingun;
        } else if (*player).weaponowned[wp_shotgun as ::core::ffi::c_int as usize]
            && (*player).ammo[am_shell as ::core::ffi::c_int as usize] != 0
        {
            (*player).pendingweapon = wp_shotgun;
        } else if (*player).ammo[am_clip as ::core::ffi::c_int as usize] != 0 {
            (*player).pendingweapon = wp_pistol;
        } else if (*player).weaponowned[wp_chainsaw as ::core::ffi::c_int as usize]
        {
            (*player).pendingweapon = wp_chainsaw;
        } else if (*player).weaponowned[wp_missile as ::core::ffi::c_int as usize]
            && (*player).ammo[am_misl as ::core::ffi::c_int as usize] != 0
        {
            (*player).pendingweapon = wp_missile;
        } else if (*player).weaponowned[wp_bfg as ::core::ffi::c_int as usize]
